            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-film fa-fw"></i> Filme<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{!!URL::to('/filme/create')!!}"><i class='fa fa-plus fa-fw'></i> Adicionar</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bank fa-fw"></i> Topico<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{!!URL::to('/topico/create')!!}"><i class='fa fa-plus fa-fw'></i> Adicionar</a>
                                </li>
                                <li>
                                    <a href="{!!URL::to('/topico')!!}"><i class='fa fa-list-ol fa-fw'></i> empresas</a>
                                </li>
                            </ul>
                        </li>
